            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <a href="{{ route('direktur.pengajuan-cuti') }}" class="btn btn-secondary">Kembali</a>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('direktur.setujui-pengajuan-cuti', $pengajuanCuti->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('PATCH')
                            ...
                            <!-- Tombol Tolak -->
                            <form action="{{ route('direktur.tolak-pengajuan-cuti', $pengajuanCuti->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('PATCH')
